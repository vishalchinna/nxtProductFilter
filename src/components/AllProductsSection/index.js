...
class AllProductsSection extends Component {
  ...
  renderProductsList = () => {
    ...
    const shouldProductList = productsList.length === 0

    // TODO: Add No Products View
    return shouldProductList ? (
      <div>
        <img
    ...
    return (
      <div className="all-products-section">
        ...
        <FiltersGroup
          ...
          searchEnterInput={this.searchEnterInput}
          onChangeCategory={this.onChangeCategory}
          changeRating={this.changeRating}
          onChangeClearAllFilters={this.onChangeClearAllFilters}
        />
